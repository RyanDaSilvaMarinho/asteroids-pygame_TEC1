...
# This file defines the UFO enemy entity and its firing behavior.
...
from entities.bullets import UfoBullet


class UFO(pg.sprite.Sprite):
    """Enemy UFO that flies across the screen and shoots at the player."""
    ...
    def fire_at(self, target_pos: Vec) -> "UfoBullet | None":
        """Fire a bullet toward target_pos with accuracy based on UFO type."""
        if self.cool > 0:
            return None
